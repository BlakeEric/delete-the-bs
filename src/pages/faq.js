...
const FaqPage = () => (
  <>
    <Head>
      ...
      <title>Frequently Asked Questions - Delete the BS</title>
    ...
    <Layout>
        ...
        <section>
          ...
          <Link href="/"><a className="button-light">&larr; Delete More BS</a></Link>
        </section>
    </Layout>
    <AppStyles />
  </>
